          ...
          <Col lg={6}>
            <FormGroup>
              ...
              <textarea
                ...
                type="text"
                value={isDutyAndTaxes.description}
...
export default UpsertDutyAndTaxes;
