...
function JobWorkSent() {
  ...
  const columns = [
    ...
    },
    {
      ...
      selector: (row) =>
        row.substring(31).substring(0, row.substring(31).length - 16),
    },
    {
  ...
  const fetchData = async () => {
    try {
      ...
      const objectNames = allObjectReferences
        ...
        .filter((object) => object.includes("vendout"));
        ...
        <Row className="mt-5">
          <div className="col">
            ...
            >
              ...
              >
                <h3 className="text-white mb-0">All Job Sent Bill</h3>
              </CardHeader>
              <DataTable
                        ...
                        value={
                          selectedRow
                            ? selectedRow
                                ...
                                .substring(
                                  0,
                                  selectedRow.substring(31).length - 16
                                )
                            : ""
                        }
                      />
