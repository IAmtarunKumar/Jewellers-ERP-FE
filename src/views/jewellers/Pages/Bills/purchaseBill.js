...
function PurchaseBill() {
  ...
  const columns = [
    ...
    },
    {
      ...
      selector: (row) =>
        row.substring(32).substring(0, row.substring(32).length - 16),
    },
    {
  ...
  const fetchData = async () => {
    try {
      ...
      const objectNames = allObjectReferences
        ...
        .filter((object) => object.includes("suppfrom"));
        ...
        <Row className="mt-5">
          <div className="col">
            ...
            >
              ...
              >
                <h3 className="text-white mb-0">All Purchase Bill</h3>
              </CardHeader>
              <DataTable
                        ...
                        value={
                          selectedRow
                            ? selectedRow
                              ...
                              .substring(
                                0,
                                selectedRow.substring(32).length - 16
                              )
                            : ""
                        }
                      />
