...
const RepairTaxModal = ({
  ...
  return (
    <Modal isOpen={taxModal} toggle={toggleTaxModal}>
      <ModalHeader toggle={toggleTaxModal}>Add a new tax</ModalHeader>
      <ModalBody>
        <Form>
          <Container>
            <Row>
